    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4 font-sans selection:bg-neutral-200">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-500 mt-2 text-sm">We'll email you a link to reset your password.</p>
        </div>
        ...
        <Card className="p-8 shadow-xl border-neutral-200/60 bg-white/80 backdrop-blur-xl rounded-2xl">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-neutral-500 text-sm">We've sent password reset instructions to <strong>{email}</strong>.</p>
              <a href="/login" className="block text-sm font-bold text-neutral-900 hover:underline pt-4">Back to Login</a>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center pt-2">
                <a href="/login" className="text-xs text-neutral-500 hover:text-neutral-950 font-bold">Back to Sign In</a>
              </div>
            </form>
          )}
        </Card>
