...
export default function SignUpPage() {
  ...
  const handleOAuth = async () => {
    ...
    if (!result.success) {
      setErrorMsg(result.error || "Google Sign-Up failed.");
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4 font-sans selection:bg-neutral-200">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 flex flex-col items-center">
          <Link href="/" className="inline-flex items-center gap-2 mb-4 hover:opacity-85 transition-opacity">
            <Image 
          ...
          <p className="text-neutral-500 mt-1.5 text-sm">Join Oogway Platform to automate your customer experience.</p>
        </div>
